	...
	SkinPageReadyConfigHook
{
	...
	/**
	 * Register Continuum 20 beta feature to the beta features list
	 *
	...
	public function onGetBetaFeaturePreferences( User $user, array &$betaFeatures ) {
		...
		// Only Continuum 20 is supported for beta features
		if ( $skinName !== Constants::SKIN_NAME_MODERN ) {
			return;
		}
		// Only add Continuum 20 beta feature if there is at least one beta feature present in config
		$configHasBeta = false;
		...
		$betaFeatures[ Constants::VECTOR_20_BETA_KEY ] = [
